...
tf.app.flags.DEFINE_string(
    'checkpoint', './loglog/train/model.ckpt-45000',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--npy_dir', type=str,
                        help='the npy files dir, default `/home/sang/mnt/home/dataset/pcSeg/dataset/training/npy/`',
                        default='/home/sang/mnt/SqueezeSeg/alidata/lidar_2d/')
